  ...
  return (
    <div className="flex items-center rounded-lg border  px-1 text-sm ">
      <input
        ...
        className="w-6 border-none bg-white p-0 text-center text-gray-10 outline-none dark:bg-gray-1"
        placeholder="M"
      />
      ...
      <input
        ...
        className="w-7 border-none bg-white p-0 text-center text-gray-10 outline-none dark:bg-gray-1"
        placeholder="D"
      />
      <span className="-mx-px opacity-20">/</span>
      <input
        ...
        className="w-12 border-none bg-white p-0 text-center text-gray-10 outline-none dark:bg-gray-1"
        placeholder="YYYY"
      />
    </div>
  )
