  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-black hover:bg-black focus:bg-black text-white rounded-md",
        day_today: "bg-accent text-accent-foreground",
        day_outside: "text-muted-foreground opacity-40 invisible",
        day_disabled: "text-muted-foreground opacity-40",
        day_range_middle: "aria-selected:bg-slate-3  aria-selected:text-gray-12 rounded-none",
